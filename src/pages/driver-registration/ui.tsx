...
type Props = MainStackScreenProps<"DriverRegistration">;
...
export function DriverRegistrationScreen({ navigation }: Props) {
  ...
  const register = useRegister({
    onSuccess: (response) => {
      ...
      Alert.alert(
        "Успешно",
        "Водитель зарегистрирован. Пароль: " +
    ...
    onError: (error: any) => {
      ...
      Alert.alert("Ошибка", "Не удалось зарегистрировать водителя");
    },
  });
    ...
    >
      ...
      >
        <View style={styles.form}>
          ...
          {/* Submit Button */}
          <Button
            title="Зарегистрировать водителя"
